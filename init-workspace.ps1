...
dotnet sln Telara.sln add Telara.Domain/Telara.Domain.csproj
dotnet sln Telara.sln add Telara.Core/Telara.Core.csproj
dotnet sln Telara.sln add Telara.OpsApi/Telara.OpsApi.csproj
